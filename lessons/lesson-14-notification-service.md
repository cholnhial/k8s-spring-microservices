# notification-service — Kafka StatefulSet & Headless Services: Notification Service

**Status:** [ ] Complete
**K8s Concepts:** StatefulSet (Kafka+Zookeeper), Headless Service
**Spring Boot Concepts:** Spring Kafka, event-driven, pub/sub
